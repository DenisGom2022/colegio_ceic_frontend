            ...
            <div className="progress-steps">
              <div className={`progress-step ${curso ? 'completed' : 'active'}`}>
                ...
                <div className="step-content">
                  <h4 className="step-title">Curso</h4>
                  <p className="step-description">Seleccionar</p>
                </div>
              </div>
              ...
              <div className={`progress-step ${titulo && descripcion ? 'completed' : titulo ? 'active' : ''}`}>
                ...
                <div className="step-content">
                  <h4 className="step-title">Contenido</h4>
                  <p className="step-description">Definir</p>
                </div>
              </div>
              ...
              <div className={`progress-step ${punteo && fechaEntrega ? 'completed' : punteo ? 'active' : ''}`}>
                ...
                <div className="step-content">
                  ...
                  <p className="step-description">Configurar</p>
                </div>
              </div>
            </div>
            ...
            <div className="sidebar-summary">
              ...
              <div className="summary-items">
                <div className="summary-item">
                  ...
                  <span className="summary-value">{getCursoSeleccionado()?.nombre || 'N/A'}</span>
                </div>
                <div className="summary-item">
                  <span className="summary-label">Puntos:</span>
                  <span className="summary-value">{punteo}</span>
                </div>
              </div>
            </div>
          </div>
