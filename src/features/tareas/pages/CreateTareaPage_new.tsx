...
export const CreateTareaPage = () => {
  ...
  const { createTarea, error, loading } = useCreateTarea();
      ...
      <div className="main-layout">
        ...
        <div className="progress-sidebar">
          <div className="sidebar-content">
            <h3 className="sidebar-title">Progreso de Configuración</h3>
            
            <div className="progress-steps">
              <div className={`progress-step ${curso ? 'completed' : 'active'}`}>
                ...
                <div className="step-content">
                  <h4 className="step-title">Selección de Curso</h4>
                  <p className="step-description">Elija el curso académico</p>
                </div>
              </div>

              <div className={`progress-step ${titulo && descripcion ? 'completed' : titulo ? 'active' : ''}`}>
                <div className="step-indicator">
                  {titulo && descripcion ? (
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                      <path d="M20 6L9 17l-5-5" stroke="currentColor" strokeWidth="2"/>
                ...
                <div className="step-content">
                  <h4 className="step-title">Especificaciones</h4>
                  <p className="step-description">Definir contenido y objetivos</p>
                </div>
              </div>

              <div className={`progress-step ${punteo && fechaEntrega ? 'completed' : punteo ? 'active' : ''}`}>
                <div className="step-indicator">
                  {punteo && fechaEntrega ? (
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                      <path d="M20 6L9 17l-5-5" stroke="currentColor" strokeWidth="2"/>
                ...
                <div className="step-content">
                  <h4 className="step-title">Evaluación</h4>
                  <p className="step-description">Configurar valoración y fechas</p>
                </div>
              </div>
            </div>

            <div className="sidebar-summary">
              <h4 className="summary-title">Resumen de la Configuración</h4>
              <div className="summary-items">
                <div className="summary-item">
                  <span className="summary-label">Curso:</span>
                  <span className="summary-value">{getCursoSeleccionado()?.nombre || 'No seleccionado'}</span>
                </div>
                <div className="summary-item">
                  <span className="summary-label">Bimestre:</span>
                  <span className="summary-value">{bimestre || 'No especificado'}</span>
                </div>
                <div className="summary-item">
                  <span className="summary-label">Valoración:</span>
                  <span className="summary-value">{punteo} puntos</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <form className="professional-form" onSubmit={submitForm}>
              ...
              <div className="form-card">
                <div className="card-header">
                  ...
                  <div className="header-content">
                    <h2 className="card-title">Selección de Curso Académico</h2>
                    <p className="card-description">Especifique el curso y período académico para la nueva actividad</p>
                  </div>
                    ...
                    <div className="form-group">
                      ...
                      <div className="select-container">
                        <select
                          ...
                          required
                        >
                          <option value="">Seleccione un curso académico</option>
                          {misCursosActivos?.map((curso) => (
                            <option key={curso.id} value={curso.id}>
                              {curso.nombre} - {curso.gradoCiclo?.grado?.nombre} ({curso.gradoCiclo?.grado?.nivelAcademico?.descripcion})
                            </option>
                          ))}
                        </select>
        ...
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3 className="modal-title">Seleccionar Curso</h3>
